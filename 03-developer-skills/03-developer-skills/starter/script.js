...
// // 1. Split → Reverse → Join (classic Stack Overflow answer)
// // 2. Manual Loop (educational approach)
// // 3. Spread Operator + Reverse + Join (modern ES6)
...
//         // BUG: Should be < not <=
//         total += scores[i]; // BUG: Accessing out-of-bounds index on last iteration
//     }
...
//         console.warn("Warning: Expected objects, got", typeof data)
//     }
